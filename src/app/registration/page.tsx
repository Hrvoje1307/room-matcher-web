                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Box css={{ marginBottom: "20px" }}>
                            ...
                            <input
                                ...
                                className={errors.fullName ? inputErrorCss : inputCss}
                            />
                            {errors.fullName && (
                        ...
                        <Box css={{ marginBottom: "20px" }}>
                            ...
                            <input
                                ...
                                className={errors.email ? inputErrorCss : inputCss}
                            />
                            {errors.email && (
                                <styled.p css={{ fontSize: "12px", color: "red.500", marginTop: "4px" }}>
                        ...
                        <Box css={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "20px" }}>
                            <Box>
                                ...
                                <input
                                    ...
                                    type="text"
                                    placeholder="Zagreb"
                                    className={errors.city ? inputErrorCss : inputCss}
                                />
                                {errors.city && (
                                    <styled.p css={{ fontSize: "12px", color: "red.500", marginTop: "4px" }}>
                                        {errors.city.message}
                        ...
                        <styled.p css={{ fontSize: "12px", color: "gray.500", textAlign: "center", marginTop: "16px", lineHeight: "1.6" }}>
                            ...
                            <Link href="#" className={css({ color: "navy.500", _hover: { color: "coral.500" } })}>
                                Uvjete korištenja
                            </Link>{" "}
                            i{" "}
                            <Link href="#" className={css({ color: "navy.500", _hover: { color: "coral.500" } })}>
